...
# Assign a file-handler to the logging instance
...
class DownloadWorker(Thread):
    ...
    - Format your response as a single json following this format:
        ...
        "tone_1": "<tone associated with this segment>",
        ...
        "tone_2": "<tone associated with the second segment (if applicable)>",
...
gpt_df = gpt_df.merge(df_chunk[['text_chunk_id','Document','text','to_translate','validation', \
                                'dont_run','Comment_counts','attachment_text_counts']], 
                      how='left', 
